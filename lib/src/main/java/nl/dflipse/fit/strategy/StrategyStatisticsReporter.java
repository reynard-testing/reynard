...
public class StrategyStatisticsReporter {
    ...
    public void reportGenerator(IncreasingSizeMixedGenerator generator, int maxKeyLength) {
        ...
        printKeyValue("Redundant faultloads", store.getRedundantFaultloads(), maxKeyLength);
        printKeyValue("Redundant fault points", store.getRedundantUidSubsets(), maxKeyLength);
        printKeyValue("Redundant fault subsets", store.getRedundantFaultSubsets(), maxKeyLength);
    }
